...
-------------------- Auto Updater
local sN, sF, vF, cV = GetScriptName(), "https://raw.githubusercontent.com/Zack2kl/Lua-Pack/master/Lua_Pack.lua", "https://raw.githubusercontent.com/Zack2kl/Lua-Pack/master/version.txt", "2.0.0"
...
-------------------- View Model Extender | Spectator list fix / made by anue | Disable Post Processing | full bright | Engine Radar | Disable Fake angle ghost while in air/freeze time | ghost view | fake duck indicator | disable fog | disable shadows | Knife on Left Hand | Fix Bomb Planting | Scoped Fov Fix | zeusbot | flash alpha
