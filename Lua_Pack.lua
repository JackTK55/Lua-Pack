...
local G_M1 = gui.Groupbox(M_Ref1, "Extra Features", 0, 206, 200, 271)
-------------- Font
...
local scriptFile = "https://raw.githubusercontent.com/Zack2kl/Lua-Pack/master/Lua_Pack.lua" local versionFile = "https://raw.githubusercontent.com/Zack2kl/Lua-Pack/master/version.txt" local currentVersion = "1.3.9" 
