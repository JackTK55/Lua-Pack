...
local SetConVar, FindByClass, GetLocalPlayer = client.SetConVar, entities.FindByClass, entities.GetLocalPlayer
...
local colors = gui.ColorPicker(group, 'world_modulation', 'World Modulation', 255, 0, 0, 255)
local sli_exposure = gui.Slider(group, 'sli_exposure', 'World Exposure', 100, 1, 100)
local sli_modelAmbient = gui.Slider(group, 'sli_modelAmbient', 'Model Ambient', 1, 1, 100)
local sli_bloom = gui.Slider(group, 'sli_bloom', 'Bloom Scale', 20, 1, 100)
