...
local mode = gui.Combobox( group, 'baim_on_key_mode', 'Mode', 'Hold', 'Toggle' )
...
local active = { [true]={['bodyaim.force']=1, ['bodyaim.lethal']=0, ['bodyaim.onshot']=0, ['bodyaim.safepoint']=0, ['prefersafe']=0, ['forcesafe']=1, ['forcesafelimbs']=0}, [false]={} }
