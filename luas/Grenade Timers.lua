...
local function grenade_timer_events(e)
...
local function smoke_and_molotov_timers()
...
local function grenade_and_flash_timers(b)
...
Register("Draw", smoke_and_molotov_timers) 
Register("DrawESP", grenade_and_flash_timers) 
Register("FireGameEvent", grenade_timer_events)